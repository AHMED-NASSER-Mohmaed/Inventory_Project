...
export class AddProductsComponent implements OnInit, OnDestroy{
  ...
  currentFilter: string = '';
      ...
      loadProducts(): void {
        ...
        const obs = this.addProductForSellerService.getPaginatedProducts(
          this.currentPage,
          this.itemsPerPage,
          filterParam,
          sortParam
      ...
      loadSuppliers(): void {
        const sub = this.addProductForSellerService.getAllSuppliers().subscribe({
          next: (res) => {
      ...
      deActivateProduct(productId: string): void {
        const sub = this.addProductForSellerService.deactivateProduct(productId).subscribe({
          next: (res) => {
            console.log(res);
      ...
      activateProduct(productId: string): void {
        const sub = this.addProductForSellerService.activateProduct(productId).subscribe({
          next: (res) => {
            console.log(res);
      ...
      getActiveProductsCount(): void {
        const sub = this.addProductForSellerService.getActiveProductsCount().subscribe({
          next: (res) => {
      ...
      getInActiveProductsCount(): void {
        const sub = this.addProductForSellerService.getInactiveProductsCount().subscribe({
          next: (res) => {
      ...
      deleteImageDirectly(imageId: string): void {
        ...
        const sub = dialogRef.afterClosed().subscribe((result) => {
          if (result) {
            this.addProductForSellerService.deleteProductImage(this.selectedProduct.product._id, imageId).subscribe({
              next: (res) => {
      ...
      updateImages(): void {
        ...
        this.addProductForSellerService.updateProductImages(
      ...
      updateStock(): void {
        ...
        this.addProductForSellerService.updateProductStock(
      ...
      exportProduct(): void {
        ...
        this.addProductForSellerService.exportProduct(
          this.selectedProduct._id,
      ...
      addNewProduct(): void {
        ...
        this.addProductForSellerService.addProduct(this.newProduct).subscribe({
          next: (res) => {
      ...
      loadBranches(): void {
        const sub = this.addProductForSellerService.getMappedBranches().subscribe({
          next: (res) => {
