...
export class ProductsComponent implements OnInit, OnDestroy{
  ...
  currentFilter: string = '';
    ...
    loadSuppliers(): void {
      const sub = this.sellerProductsService.getAllSuppliers().subscribe({
        next: (res) => {
    ...
    getActiveProductsCount(): void {
      const sub = this.sellerProductsService.getActiveProductsCount().subscribe({
        next: (res) => {
    ...
    getInActiveProductsCount(): void {
      const sub = this.sellerProductsService.getInactiveProductsCount().subscribe({
        next: (res) => {
    ...
    deleteImageDirectly(imageId: string): void {
      ...
      const sub = dialogRef.afterClosed().subscribe((result) => {
        if (result) {
          this.sellerProductsService.deleteProductImage(this.selectedProduct.product._id, imageId).subscribe({
            next: (res) => {
    ...
    updateImages(): void {
      ...
      this.sellerProductsService.updateProductImages(
    ...
    updateStock(): void {
      ...
      this.sellerProductsService.updateProductStock(
    ...
    exportProduct(): void {
      ...
      this.sellerProductsService.exportProduct(
        this.selectedProduct._id,
    ...
    addNewProduct(): void {
      ...
      this.sellerProductsService.addProduct(this.newProduct).subscribe({
        next: (res) => {
    ...
    loadBranches(): void {
      const sub = this.sellerProductsService.getMappedBranches().subscribe({
        next: (res) => {
