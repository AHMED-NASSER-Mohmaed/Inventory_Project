...
@Component({
  selector: 'app-cashier-offline-processing',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './cashier-offline-processing.component.html',
  styleUrl: './cashier-offline-processing.component.css'
})
export class CashierOfflineProcessingComponent {
