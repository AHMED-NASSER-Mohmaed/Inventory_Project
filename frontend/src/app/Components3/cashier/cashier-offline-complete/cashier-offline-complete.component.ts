...
@Component({
  selector: 'app-cashier-offline-complete',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './cashier-offline-complete.component.html',
  styleUrl: './cashier-offline-complete.component.css'
})
export class CashierOfflineCompleteComponent {
