...
@Component({
  selector: 'app-cashier-offline-cancelled',
  imports: [
    CommonModule,
    FormsModule,
  ...
  templateUrl: './cashier-offline-cancelled.component.html',
  styleUrl: './cashier-offline-cancelled.component.css'
})
export class CashierOfflineCancelledComponent {
