...
@Component({
  selector: 'app-cashier-offline-dashboard',
  imports: [CommonModule,
    RouterModule],
  templateUrl: './cashier-offline-dashboard.component.html',
  styleUrl: './cashier-offline-dashboard.component.css'
})
export class CashierOfflineDashboardComponent {
