...
@Component({
  selector: 'app-clerk-offline-dashboard',
  imports: [CommonModule,
    RouterModule],
  templateUrl: './clerk-offline-dashboard.component.html',
  styleUrl: './clerk-offline-dashboard.component.css'
})
export class ClerkOfflineDashboardComponent {
